...
class AppColors {
  ...
  //Blue
  static final Color blue = Color(0xFF398AE5);
  static final Color buttonBlue = Color(0xFF478DE0);

  //LinearGradient
  static final Color linearGradient1 =  Color(0xFF73AEF5);
  static final Color linearGradient2 =  Color(0xFF61A4F1);
  static final Color linearGradient3 =  Color(0xFF478DE0);
  static final Color linearGradient4 =  Color(0xFF398AE5);
