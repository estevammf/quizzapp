...
extension LevelStringExt on String{
  Level? get levelParce => {"facil": Level.facil, "medio": Level.medio, "dificil": Level.dificil, "perito": Level.perito}[this];
}

extension LevelExt on Level?{
  String? get parce => {Level.facil: "facil",Level.medio: "medio", Level.dificil: "dificil", Level.perito: "perito"}[this!];
}
